<html>
    <head><title>Gudang</title></head>
        // masukkan dulu informatika.sql saya yang ada di github L200170168/pwd/modul 5/tugas karena databasenya sudah saya tambahkan table gudang untuk tugas ini
    <?php
                    ...
                    while($data=mysqli_fetch_row($hasil_cari)){
                        echo "
                            <tr>
                                ...
                                <td>$data[1]</td>
                                <td>$data[2]</td>
                                <td><a href='gudangubah.php?kode_gudang=$data[0]'>Ubah</a></td>
                                <td><a href='gudanghapus.php?kode_gudang=$data[0]'>Hapus</a></td>
                            </tr>
                        ";
                    }
                ?>
